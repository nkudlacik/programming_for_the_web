...
function deleteCard(id) {
  ...
  const updatedArray = decks.filter((designDeck) => {
    return designDeck.id !== id
  })
...
function duplicateCard(id) {
  ...
  const matchingCard = decks.find((designDeck) => {
    return designDeck.id === id;
  });

  if (!matchingCard) return;
  const updatedDeck = { ...matchingCard, id: nanoid() };
